...
const PROXY_BASE = '';
const APP_ID = '69eb31d0cef13ab397a4d85f';
...
export default function PublicFormSchichtplanung() {
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-lg">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-foreground">Schichtplanung — Formular</h1>
        </div>
